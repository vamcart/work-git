...
// class constructor
    function __construct() {
      ...
      $this->code = 'alfabank';
      $this->title = defined('MODULE_PAYMENT_ALFABANK_TEXT_TITLE') ? MODULE_PAYMENT_ALFABANK_TEXT_TITLE : null;
      $this->public_title = defined('MODULE_PAYMENT_ALFABANK_TEXT_PUBLIC_TITLE') ? MODULE_PAYMENT_ALFABANK_TEXT_PUBLIC_TITLE : null;
      $this->icon = DIR_WS_ICONS . 'alfabank.png';
      $this->description = defined('MODULE_PAYMENT_ALFABANK_TEXT_ADMIN_DESCRIPTION') ? MODULE_PAYMENT_ALFABANK_TEXT_ADMIN_DESCRIPTION : null;
      $this->sort_order = defined('MODULE_PAYMENT_ALFABANK_SORT_ORDER') ? MODULE_PAYMENT_ALFABANK_SORT_ORDER : null;
      $this->enabled = ((defined('MODULE_PAYMENT_ALFABANK_STATUS') && MODULE_PAYMENT_ALFABANK_STATUS == 'True') ? true : false);

      ((defined('MODULE_PAYMENT_ALFABANK_TEST') && MODULE_PAYMENT_ALFABANK_TEST == 'test') ? $this->form_action_url = 'https://alfa.rbsuat.com/payment/rest/' : $this->form_action_url = 'https://payment.alfabank.ru/payment/rest/');
        ...
        if ($send_check == 1) {
            ...
            if ($order->products) {
                foreach ($order->products as $product) {
                    ...
                    $item['name'] = mb_substr(htmlspecialchars(json_encode($product['name']), ENT_QUOTES, 'UTF-8'),0,64);
                    $item['quantity'] = array(
                        'value' => $product['qty'],
                        'measure' => "piece"
                    );
