...
// EOF manufacturers meta tags
  switch ($_GET['action']) {
    ...
    case 'save':
	  ...
	  $customers_balance_added_manufacturers = vam_db_prepare_input($_POST['customers_balance_added_manufacturers']);
      
      $sql_data_array = array(
      
      'manufacturers_name' => $manufacturers_name,
      'customers_balance_added_manufacturers'=>$customers_balance_added_manufacturers,
...
<?php
  $manufacturers_query_raw = "select manufacturers_id, manufacturers_name, manufacturers_seo_url, manufacturers_status, sort_order,  customers_balance_added_manufacturers, manufacturers_image, date_added, last_modified from " . TABLE_MANUFACTURERS . " order by manufacturers_name";
...
<?php
  ...
  switch ($_GET['action']) {
    case 'new':
      ...
      $contents[] = array('text' => '<br />'.TEXT_BONUS_PERCENT.'<br />' . vam_draw_input_field('customers_balance_added_manufacturers'));
...
// EOF manufacturers meta tags
      ...
      if(is_object($mInfo)) $mInfo->manufacturers_status = 1;
    ...
    case 'edit':
	  ...
	  $contents[] = array('text' => '<br />'.TEXT_BONUS_PERCENT.'<br />' . vam_draw_input_field('customers_balance_added_manufacturers', $mInfo->customers_balance_added_manufacturers));
