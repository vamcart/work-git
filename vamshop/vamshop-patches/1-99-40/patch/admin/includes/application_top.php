...
// include composer autoload
  ...
  define('FILENAME_KVITANCIA', 'kvitancia.php');
  define('FILENAME_SCHET', 'schet.php');

  define('FILENAME_LICENSE', 'license.php');

  define('TABLE_NOTIFICATIONS', 'notifications');
  define('FILENAME_NOTIFICATIONS', 'notifications.php');
