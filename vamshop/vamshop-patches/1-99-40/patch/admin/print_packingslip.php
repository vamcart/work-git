...
// EOF barcode
	...
	$vamTemplate->assign('packingslip1', defined('MODULE_PAYMENT_SCHET_1') ? MODULE_PAYMENT_SCHET_1 : '');
	$vamTemplate->assign('packingslip2', defined('MODULE_PAYMENT_SCHET_2') ? MODULE_PAYMENT_SCHET_2 : '');
	$vamTemplate->assign('packingslip3', defined('MODULE_PAYMENT_SCHET_3') ? MODULE_PAYMENT_SCHET_3 : '');
	$vamTemplate->assign('packingslip4', defined('MODULE_PAYMENT_SCHET_4') ? MODULE_PAYMENT_SCHET_4 : '');
	$vamTemplate->assign('packingslip5', defined('MODULE_PAYMENT_SCHET_5') ? MODULE_PAYMENT_SCHET_5 : '');
	$vamTemplate->assign('packingslip6', defined('MODULE_PAYMENT_SCHET_6') ? MODULE_PAYMENT_SCHET_6 : '');
	$vamTemplate->assign('packingslip7', defined('MODULE_PAYMENT_SCHET_7') ? MODULE_PAYMENT_SCHET_7 : '');
	$vamTemplate->assign('packingslip8', defined('MODULE_PAYMENT_SCHET_8') ? MODULE_PAYMENT_SCHET_8 : '');
	$vamTemplate->assign('packingslip9', defined('MODULE_PAYMENT_SCHET_9') ? MODULE_PAYMENT_SCHET_9 : '');
	$vamTemplate->assign('packingslip10', defined('MODULE_PAYMENT_SCHET_10') ? MODULE_PAYMENT_SCHET_10 : '');
	$vamTemplate->assign('packingslip11', defined('MODULE_PAYMENT_SCHET_11') ? MODULE_PAYMENT_SCHET_11 : '');
	$vamTemplate->assign('packingslip12', defined('MODULE_PAYMENT_SCHET_12') ? MODULE_PAYMENT_SCHET_12 : '');
