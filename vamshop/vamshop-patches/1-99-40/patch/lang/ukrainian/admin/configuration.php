...
define('RETAILCRM_DOMAIN_TITLE' , 'Ваш домен в RetailCRM. Подробная информация по настройке VamShop и RetailCRM <a href="https://forum.vamshop.ru/topic/20475-%D0%B8%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D1%8F-vamshop-%D0%B8-retailcrm/" target="_blank"><u>здесь</u></a>.');
define('RETAILCRM_DOMAIN_DESC', 'Укажите Ваш домен в RetailCRM https://аккаунт.retailcrm.ru');
define('RETAILCRM_KEY_TITLE' , 'Ваш API ключ в RetailCRM. Подробная информация по настройке VamShop и RetailCRM <a href="https://forum.vamshop.ru/topic/20475-%D0%B8%D0%BD%D1%82%D0%B5%D0%B3%D1%80%D0%B0%D1%86%D0%B8%D1%8F-vamshop-%D0%B8-retailcrm/" target="_blank"><u>здесь</u></a>.');
define('RETAILCRM_KEY_DESC', 'Укажите Ваш API ключ в RetailCRM.');
define('RETAILCRM_SITE_TITLE' , 'RetailCRM Символьный код сайта');
define('RETAILCRM_SITE_DESC', 'Укажите символьный код сайта в RetailCRM. Посмотреть можно в Админке - Настройки - Магазины - Символьный код');

define('CG_RETAILCRM_EXCHANGE', 'RetailCRM');
define('CG_RETAILCRM_EXCHANGE_TITLE', 'RetailCRM');
define('CG_RETAILCRM_EXCHANGE_DESC', '');

define('KOVALSKY_BONUS_PERSENT_TITLE', 'Сколько процентов начислять бонусами');
define('KOVALSKY_BONUS_PERSENT_DESC', 'Сколько бонусов начислять на баланс пользователя, в процентах от стоимости заказа, пишите число, например если 5%, то пишите 5');

define('KOVALSKY_SHIPPING_FINISH_STATUS_TITLE', 'Статус доставленного заказа, когда будут начислены бонусы');
define('KOVALSKY_SHIPPING_FINISH_STATUS_DESC', 'Статус заказа, которому будут начислены бонусы. Обычно выбирается статус доставленного, оплаченного заказа.');

define('KOVALSKY_CONST_MAX_PAY_PERSENT_TITLE', 'Максимальный процент для опаты бонусами');
define('KOVALSKY_CONST_MAX_PAY_PERSENT_DESC', 'Максималный процент от стоимости заказа, который можно оплатить бонусами.');
