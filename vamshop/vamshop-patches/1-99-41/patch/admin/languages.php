...
/* --------------------------------------------------------------
  ...
  switch ($_GET['action']) {
    case 'insert':
      ...
      // create additional specification_description records
      $spec_description_query = vam_db_query("select specifications_id, specification_name, specification_description, specification_prefix, specification_suffix from " . TABLE_SPECIFICATION_DESCRIPTION . " where language_id = '" . $_SESSION['languages_id'] . "'");
      while ($spec_description = vam_db_fetch_array($spec_description_query)) {
        vam_db_query("insert into " . TABLE_SPECIFICATION_DESCRIPTION . " (specifications_id, specification_name, specification_description, specification_prefix, specification_suffix, language_id) values ('" . $spec_description['specifications_id'] . "', '" . $spec_description['specification_name'] . "', '" . $spec_description['specification_description'] . "', '" . $orders_status['specification_prefix'] . "', '" . $orders_status['specification_suffix'] . "', '" . $insert_id . "')");
      }

      // create additional specification_filters_description records
      $spec_filters_description_query = vam_db_query("select specification_filters_id, filter from " . TABLE_SPECIFICATIONS_FILTERS_DESCRIPTION . " where language_id = '" . $_SESSION['languages_id'] . "'");
      while ($spec_filters_description = vam_db_fetch_array($spec_filters_description_query)) {
        vam_db_query("insert into " . TABLE_SPECIFICATIONS_FILTERS_DESCRIPTION . " (specification_filters_id, filter, language_id) values ('" . $spec_filters_description['specification_filters_id'] . "', '" . $spec_filters_description['filter'] . "', '" . $insert_id . "')");
      }

      // create additional specification_values_description records
      $spec_values_description_query = vam_db_query("select specification_values_id, specification_value from " . TABLE_SPECIFICATIONS_VALUES_DESCRIPTION . " where language_id = '" . $_SESSION['languages_id'] . "'");
      while ($spec_values_description = vam_db_fetch_array($spec_values_description_query)) {
        vam_db_query("insert into " . TABLE_SPECIFICATIONS_VALUES_DESCRIPTION . " (specification_values_id, specification_value, language_id) values ('" . $spec_values_description['specification_values_id'] . "', '" . $spec_values_description['specification_value'] . "', '" . $insert_id . "')");
      }

      // create additional products_specifications records
      $spec_products_query = vam_db_query("select products_id, specifications_id, specification from " . TABLE_PRODUCTS_SPECIFICATIONS . " where language_id = '" . $_SESSION['languages_id'] . "'");
      while ($spec_products = vam_db_fetch_array($spec_products_query)) {
        vam_db_query("insert into " . TABLE_PRODUCTS_SPECIFICATIONS . " (products_id, specifications_id, specification, language_id) values ('" . $spec_products['products_id'] . "', '" . $spec_products['specifications_id'] . "', '" . $spec_products['specification'] . "', '" . $insert_id . "')");
      }
    ...
    case 'deleteconfirm':
      ...
      vam_db_query("delete from " . TABLE_SPECIFICATION_DESCRIPTION . " where language_id = '" . vam_db_input($lID) . "'");
      vam_db_query("delete from " . TABLE_SPECIFICATIONS_FILTERS_DESCRIPTION . " where language_id = '" . vam_db_input($lID) . "'");
      vam_db_query("delete from " . TABLE_SPECIFICATIONS_VALUES_DESCRIPTION . " where language_id = '" . vam_db_input($lID) . "'");
      vam_db_query("delete from " . TABLE_PRODUCTS_SPECIFICATIONS . " where language_id = '" . vam_db_input($lID) . "'");
...
<?php
  $direction_options = array( array('id' => '', 'text' => defined('TEXT_INFO_LANGUAGE_DIRECTION_DEFAULT') ? TEXT_INFO_LANGUAGE_DIRECTION_DEFAULT : false),
                              array('id' => 'ltr', 'text' => defined('TEXT_INFO_LANGUAGE_DIRECTION_LEFT_TO_RIGHT') ? TEXT_INFO_LANGUAGE_DIRECTION_LEFT_TO_RIGHT : false),
                              array('id' => 'rtl', 'text' => defined('TEXT_INFO_LANGUAGE_DIRECTION_RIGHT_TO_LEFT') ? TEXT_INFO_LANGUAGE_DIRECTION_RIGHT_TO_LEFT : false));
