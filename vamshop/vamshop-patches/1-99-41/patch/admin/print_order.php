...
function get_string($summ,$nominal){ 
 ...
 return trim($retval); 
  ...
  $company = vam_db_fetch_array($company_query);
	...
	$vamTemplate->assign('company_name', html_entity_decode($company['name']));
 ...
 // if ($_SESSION['customer_id'] == $order_check['customers_id'])
  //	{
	...
	$vamTemplate->assign('schet1', defined('MODULE_PAYMENT_SCHET_1') ? MODULE_PAYMENT_SCHET_1 : '');
	$vamTemplate->assign('schet2', defined('MODULE_PAYMENT_SCHET_2') ? MODULE_PAYMENT_SCHET_2 : '');
	$vamTemplate->assign('schet3', defined('MODULE_PAYMENT_SCHET_3') ? MODULE_PAYMENT_SCHET_3 : '');
	$vamTemplate->assign('schet4', defined('MODULE_PAYMENT_SCHET_4') ? MODULE_PAYMENT_SCHET_4 : '');
	$vamTemplate->assign('schet5', defined('MODULE_PAYMENT_SCHET_5') ? MODULE_PAYMENT_SCHET_5 : '');
	$vamTemplate->assign('schet6', defined('MODULE_PAYMENT_SCHET_6') ? MODULE_PAYMENT_SCHET_6 : '');
	$vamTemplate->assign('schet7', defined('MODULE_PAYMENT_SCHET_7') ? MODULE_PAYMENT_SCHET_7 : '');
	$vamTemplate->assign('schet8', defined('MODULE_PAYMENT_SCHET_8') ? MODULE_PAYMENT_SCHET_8 : '');
	$vamTemplate->assign('schet9', defined('MODULE_PAYMENT_SCHET_9') ? MODULE_PAYMENT_SCHET_9 : '');
	$vamTemplate->assign('schet10', defined('MODULE_PAYMENT_SCHET_10') ? MODULE_PAYMENT_SCHET_10 : '');
	$vamTemplate->assign('schet11', defined('MODULE_PAYMENT_SCHET_11') ? MODULE_PAYMENT_SCHET_11 : '');
	$vamTemplate->assign('schet12', defined('MODULE_PAYMENT_SCHET_12') ? MODULE_PAYMENT_SCHET_12 : '');
