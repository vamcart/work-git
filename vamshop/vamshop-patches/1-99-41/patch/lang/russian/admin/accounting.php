...
define('ACCESS_TAGS','Админка - Контент - Плитка тэгов');
define('ACCESS_FAQ1','Админка - Контент - Вопросы посетителей');
define('ACCESS_BLOCK','Админка - Контент - Закрыть от индексации');
define('ACCESS_ORDER_FUNCTIONS','');

define('ACCESS_POST_PAYMENT','');
define('ACCESS_POST_STICKER','');
define('ACCESS_SENDER_FORM','');
define('ACCESS_LICENSE','Админка - Настройки - Лицензия');
define('ACCESS_NOTIFICATIONS','');
define('ACCESS_CUSTOMERS_BALANCE','');
