...
define('PROJECT_VERSION', 'VamShop 1.99.41');
...
require_once (DIR_FS_INC.'vam_get_manufacturer_rating.inc.php');
require_once (DIR_FS_INC.'vam_get_manufacturer_rating_count.inc.php');
require_once (DIR_FS_INC.'vam_render.inc.php');
...
require_once (DIR_FS_CATALOG . 'includes/external/phpmailer/src/Exception.php');
require_once (DIR_FS_CATALOG . 'includes/external/phpmailer/src/PHPMailer.php');

if (EMAIL_TRANSPORT == 'smtp')
require_once (DIR_FS_CATALOG . 'includes/external/phpmailer/src/SMTP.php');
...
//require (DIR_WS_CLASSES.'check.php');
//$check = new check;

//echo var_dump($check->check_domain(LICENSE_KEY));
//$check->get_info();
